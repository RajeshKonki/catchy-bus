...
class BusRouteModel with _$BusRouteModel {
  ...
  factory BusRouteModel.fromJson(Map<String, dynamic> json) {
    ...
    if (trips.isNotEmpty) {
      ...
      for (var s in passedList) {
        if (s['name'] != null) {
          passedStopsMap[s['name']] = s;
          
          // Collect all student IDs that have boarded during this trip
          final studentIds = s['studentIds'] as List? ?? [];
    ...
    return BusRouteModel(
      ...
      busPosition: json['busPosition'] != null
          ? BusPositionModel.fromJson(json['busPosition'])
          : json['bus_position'] != null
          ? BusPositionModel.fromJson(json['bus_position'])
          : BusPositionModel(
              latitude:
                  (json['currentLat'] ??
                          routeData['startLat'] ??
  ...
  static List<RoutePointModel> _parseRoutePath(Map<String, dynamic> json, Map<String, dynamic> routeData) {
    ...
    if (pathData is List && pathData.isNotEmpty) {
      return pathData.map((p) => RoutePointModel.fromJson(p)).toList();
    }
...
class BusSummaryModel with _$BusSummaryModel {
  ...
  factory BusSummaryModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['route'] != null && json['route']['stops'] != null) {
      final stopsList = json['route']['stops'] as List? ?? [];
